...
只需要双人对战的玩家，也可以下载 [`合掌网页版v2.4.html`](合掌网页版-正式版本存档/合掌网页版v2.4.html)。这是双人对战正式版，包含第二版的部分技能。
...
- [`合掌技能版（第一版）规则`](合掌技能版（第一版）_1784612659965.docx)
- [`合掌技能版（第二版）规则`](合掌技能版（第二版）_1784612320126.docx)

浏览器无法直接预览 DOCX 时，请先下载文件，再使用 Microsoft Word、WPS Office 或其他兼容软件打开。
